...
run_and_capture "set-comment" set-comment "test"
...
assert_exiv_comment "2019 test/1.jpg" "test"
assert_exiv_comment "2019 test/IMG_20190324_121437.jpg" "test"

assert_exiv_comment "other test/2.jpeg" "test"
